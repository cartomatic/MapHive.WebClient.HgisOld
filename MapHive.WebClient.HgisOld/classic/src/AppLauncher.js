    ...
    constructor: function(config){
        ...
        onLayerChange: function(rg, newV, oldV, eOpts){
            ...
            if (this.activeLayer) {
                ...
                if(this.activeRg !== rg){
                    for(var r = 0; r < this.activeRg.items.items.length; r++){
                        this.activeRg.items.items[r].setValue(false);
                    }
                }
            }
        ...
        getLayerUrls: function (type, source) {
            return [
                'https://hgiswms1.maphive.net/' + type +'/3857/' + source,
                'https://hgiswms2.maphive.net/' + type +'/3857/' + source,
                'https://hgiswms3.maphive.net/' + type +'/3857/' + source,
                'https://hgiswms4.maphive.net/' + type +'/3857/' + source
            ];
        }
    });
